    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriaProveedores", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fidelidad = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParametrosDefinidos = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParametrosUsados = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportesGenerados", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReportesGenerados_Reportes_ReporteId",
                        column: x => x.ReporteId,
                        principalTable: "Reportes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReportesGenerados_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Cod_Barra = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CotizacionDetalles_Presentaciones_PresentacionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FacturaDetalles_Presentaciones_PresentacionId",
                        column: x => x.PresentacionId,
                        principalTable: "Presentaciones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RemitosDetalles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RemitosDetalles_Presentaciones_PresentacionId",
                        column: x => x.PresentacionId,
                        principalTable: "Presentaciones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RemitosDetalles_Remitos_RemitoId",
                        column: x => x.RemitoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CotizacionDetalles_PresentacionId",
                table: "CotizacionDetalles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacturaDetalles_PresentacionId",
                table: "FacturaDetalles",
                column: "PresentacionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RemitosDetalles_PresentacionId",
                table: "RemitosDetalles",
                column: "PresentacionId");

            migrationBuilder.CreateIndex(
                name: "IX_RemitosDetalles_RemitoId",
                table: "RemitosDetalles",
                column: "RemitoId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportesGenerados_ReporteId",
                table: "ReportesGenerados",
                column: "ReporteId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportesGenerados_UsuarioId",
                table: "ReportesGenerados",
                column: "UsuarioId");
        }
